...
<header class:show_img={showImg} style:background-image={`url("${headerBG.img.src}")`}>
	<div class="container">
		<div class="content">
			<div class="main_info">
				<p class="subtitle">Забег</p>
				<div class="title">
					<h1>Ежегодный январский забег</h1>
					<div class="to-favorite">
						<Button round>
							<svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path d="M23.9727 5.521C27.8927 5.52114 31.0811 8.71478 31.0811 12.6733C31.081 14.2997 30.8214 15.7999 30.3711 17.1919L30.3691 17.1987C29.2887 20.618 27.0707 23.3833 24.6641 25.4517C22.253 27.5238 19.7093 28.8462 18.0791 29.4009L18.0684 29.4048C17.9607 29.4427 17.7535 29.479 17.4971 29.479C17.2406 29.479 17.0333 29.4427 16.9258 29.4048L16.915 29.4019L16.5996 29.2886C14.9681 28.6787 12.5916 27.3944 10.3311 25.4517C7.92438 23.3833 5.70646 20.618 4.62598 17.1987L4.62402 17.1919L4.46387 16.6655C4.11245 15.4234 3.91409 14.0967 3.91406 12.6733C3.91406 8.7147 7.10233 5.521 11.0225 5.521C13.3322 5.52102 15.4032 6.64424 16.6963 8.37256L17.4971 9.44287L18.2979 8.37256C19.5909 6.64422 21.6629 5.521 23.9727 5.521Z" stroke="#272327" stroke-width="2"/>
							</svg>
						</Button>
					</div>
				</div>
				<p class="subtitle">Почувствуй энергию зимы</p>

				<div class="actions">
					<Button accent>Принять участие</Button>
					<div class="info"><Button accent>Участие бесплатное</Button></div>
				</div>
			</div>
			<div class="rating">
				<h2>Рейтинг</h2>
